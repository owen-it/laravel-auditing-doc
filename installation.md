...
Have a look at the [Audit Migration](audit-migration.md) section for some of the changes that can be performed.
...
# Resolvers
Find out more about resolvers in the [Audit Resolvers](audit-resolvers.md) section!
